...
class MainActivityImport : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var btnRequest = findViewById(R.id.buttonImportSyncthing) as Button?
        btnRequest?.setOnClickListener(){
            if (isPackageInstalledAndEnabled(getString(R.string.syncthingPackage), packageManager)) {
                ...
                Toast.makeText(this@MainActivityImport, "Syncthing is not enabled or installed", Toast.LENGTH_LONG).show()
        }
